                    ...
                    <form action="{{ route('partners.update', $partner->id) }}" method="POST">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" style="height:50px" name="category"
                                        placeholder="Category">{{ $partner->category }}</textarea>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>Address:</strong>
                                    <input type="text" name="address" class="form-control" placeholder="{{ $partner->address }}"
                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12">
                                <div class="form-group">
                                    <strong>No HP:</strong>
                                    <input type="text" name="nohp" class="form-control" placeholder="{{ $partner->nohp }}"
                                        value="{{ $partner->nohp }}">
                                </div>
                            </div>
